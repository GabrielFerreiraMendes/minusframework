...
|--------|-------------|-----------|
| **Meta** (docs, CI/CD) | [minusframework](https://github.com/minusframework/minusframework) | Orquestração, instalador e documentação |
| **Core** | [minusframework-core](https://github.com/minusframework/minusframework-core) | Núcleo compartilhado (conexão, atributos, tipos) |
| **ORM** | [minusframework-orm](https://github.com/minusframework/minusframework-orm) | Repositório genérico, queries, mapeamento |
| **Migrator** | [minusframework-migrator](https://github.com/minusframework/minusframework-migrator) | Migração versionada de schema |
| **Messaging** | [minusframework-messaging](https://github.com/minusframework/minusframework-messaging) | Message bus, sagas, outbox |
| **Feature Flags** | [minusframework-featureflags](https://github.com/minusframework/minusframework-featureflags) | Feature toggles, SSE, REST API |
| **Extensions** | [minusframework-extensions](https://github.com/minusframework/minusframework-extensions) | Integrações Horse, JWT |
| **Telemetry** | [minusframework-telemetry](https://github.com/minusframework/minusframework-telemetry) | Tracing e logging estruturado |
| **AI** | [minusframework-ai](https://github.com/minusframework/minusframework-ai) | MCP Server e agentes inteligentes |
| **CLI** | [minusframework-cli](https://github.com/minusframework/minusframework-cli) | CLI de scaffolding |
